...
| API (FE contract) | `docs/frontend/api/API_Task034_…` đến `API_Task039_…`, `API_Task041_…` |
...
Đọc: @frontend/AGENTS/docs/FE_API_CONNECTION_GUIDE.md → @docs/frontend/api/API_Task034_products_get_list.md → grep Path trong @backend/smart-erp/src/main/java → grep trong @frontend/mini-erp/src.

Output: @docs/frontend/api/bridge/BRIDGE_Task034_products_get_list.md
```
...
**UI context (wire-fe sau):** tra [`../../../../docs/frontend/mini-erp/features/FEATURES_UI_INDEX.md`](../../../../docs/frontend/mini-erp/features/FEATURES_UI_INDEX.md) — `/products/list`, `ProductsPage`.
