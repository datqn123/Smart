...
| API (FE contract) | `docs/frontend/api/API_Task042_suppliers_get_list.md` … `API_Task047_suppliers_bulk_delete.md` |
...
Đọc: @frontend/AGENTS/docs/FE_API_CONNECTION_GUIDE.md → @docs/frontend/api/API_Task042_suppliers_get_list.md → grep Path trong @backend/smart-erp/src/main/java → grep trong @frontend/mini-erp/src.

Output: @docs/frontend/api/bridge/BRIDGE_Task042_suppliers_get_list.md
```
...
**UI context (wire-fe sau verify):** [`../../../../docs/frontend/mini-erp/features/FEATURES_UI_INDEX.md`](../../../../docs/frontend/mini-erp/features/FEATURES_UI_INDEX.md) — `/products/suppliers`, `SuppliersPage`.
