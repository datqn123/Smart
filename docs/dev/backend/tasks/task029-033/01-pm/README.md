...
| API | `docs/frontend/api/API_Task029_…` đến `API_Task033_…` |
...
3. **API_BRIDGE** (theo `WORKFLOW_RULE` §0.3): một phiên / Path hoặc theo lô — `docs/frontend/api/bridge/BRIDGE_Task029_*.md` … Task033.
