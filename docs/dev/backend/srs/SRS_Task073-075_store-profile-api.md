...
> **File (Spring / `smart-erp`):** `docs/backend/srs/SRS_Task073-075_store-profile-api.md`  
...
| :--- | :--- |
| API Task073 | [`../../../docs/frontend/api/API_Task073_store_profile_get.md`](../../../docs/frontend/api/API_Task073_store_profile_get.md) — Draft |
| API Task074 | [`../../../docs/frontend/api/API_Task074_store_profile_patch.md`](../../../docs/frontend/api/API_Task074_store_profile_patch.md) — Draft |
| API Task075 | [`../../../docs/frontend/api/API_Task075_store_profile_post_logo.md`](../../../docs/frontend/api/API_Task075_store_profile_post_logo.md) — Draft |
| Khung API | [`../../../docs/frontend/api/API_PROJECT_DESIGN.md`](../../../docs/frontend/api/API_PROJECT_DESIGN.md) §4.16 |
| Envelope | [`../../../docs/frontend/api/API_RESPONSE_ENVELOPE.md`](../../../docs/frontend/api/API_RESPONSE_ENVELOPE.md) |
| UC / DB spec (mô tả) | [`../../../docs/frontend/UC/Database_Specification.md`](../../../docs/frontend/UC/Database_Specification.md) §6.1 `StoreProfiles` |
...
| UI index | [`../../../docs/frontend/mini-erp/features/FEATURES_UI_INDEX.md`](../../../docs/frontend/mini-erp/features/FEATURES_UI_INDEX.md) — `/settings/store-info`, `StoreInfoPage` |
