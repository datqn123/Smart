...
> **File:** `docs/backend/srs/SRS_Task005_inventory-get-list.md`  
> **Người viết:** Agent BA + SQL (Draft)  
> **Ngày:** 25/04/2026 (cập nhật: hành vi tải lũy tiến phía client)  
> **Trạng thái:** Approved

**Traceability:** UC6 — màn Tồn kho (StockPage) · **API** [`../../../docs/frontend/api/API_Task005_inventory_get_list.md`](../../../docs/frontend/api/API_Task005_inventory_get_list.md) · Thiết kế API [`../../../docs/frontend/api/API_PROJECT_DESIGN.md`](../../../docs/frontend/api/API_PROJECT_DESIGN.md) (§4.7 nếu tồn tại) · Uỷ quyển mô tả cột/UC [`../../../docs/frontend/UC/Database_Specification.md`](../../../docs/frontend/UC/Database_Specification.md) (§16 tồn, §5–8 kho/SP) · **Flyway** [`../../smart-erp/src/main/resources/db/migration/V1__baseline_smart_inventory.sql`](../../smart-erp/src/main/resources/db/migration/V1__baseline_smart_inventory.sql) · **Out of scope API:** Task006 (chi tiết dòng), Task007/008/010 (ghi), Task009 (KPI tách) — theo tài liệu API.
