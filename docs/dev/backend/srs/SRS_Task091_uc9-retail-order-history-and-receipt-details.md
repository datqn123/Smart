...
> **File (Spring / `smart-erp`):** `docs/backend/srs/SRS_Task091_uc9-retail-order-history-and-receipt-details.md`  
...
| UI index | [`../../../docs/frontend/mini-erp/features/FEATURES_UI_INDEX.md`](../../../docs/frontend/mini-erp/features/FEATURES_UI_INDEX.md) — route `/orders/retail` |
| API list đơn (màn `/orders/wholesale` / lịch sử) | **Task102** [`../../../docs/frontend/api/API_Task102_sales_orders_retail_history_get_list.md`](../../../docs/frontend/api/API_Task102_sales_orders_retail_history_get_list.md) — `GET /api/v1/sales-orders/retail/history` (thay thế list qua Task054 cho use case này — xem §0.1) |
| API chi tiết đơn | [`../../../docs/frontend/api/API_Task055_sales_orders_get_by_id.md`](../../../docs/frontend/api/API_Task055_sales_orders_get_by_id.md) — `GET /api/v1/sales-orders/{id}` (dùng cho Retail) |
| Checkout POS | [`../../../docs/frontend/api/API_Task060_sales_orders_retail_checkout.md`](../../../docs/frontend/api/API_Task060_sales_orders_retail_checkout.md) — tạo đơn bán lẻ một lần |
| UC / DB spec | [`../../../docs/frontend/UC/Database_Specification.md`](../../../docs/frontend/UC/Database_Specification.md) — §19 `SalesOrders`, §20 `OrderDetails` (tham chiếu) |
