...
> **File**: `docs/backend/srs/SRS_Task101_role-based-side-menu-visibility.md`  
...
- API: `can_view_system_logs` — [`API_Task086`](../../../docs/frontend/api/API_Task086_system_logs_get_list.md); **menu *Nhật ký*** theo **Admin** + `can_view_system_logs` (không còn “luôn hiện”) — SRS PRD **Approved** 02/05/2026.  
...
- Đối chiếu `docs/frontend/database/tables/roles.md` với migration sau mỗi thay đổi JSON role.
