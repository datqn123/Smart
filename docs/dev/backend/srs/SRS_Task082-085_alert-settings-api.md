...
> **File (Spring / `smart-erp`):** `docs/backend/srs/SRS_Task082-085_alert-settings-api.md`  
...
| :--- | :--- |
| API spec | `docs/frontend/api/API_Task082_alert_settings_get_list.md` |
| API spec | `docs/frontend/api/API_Task083_alert_settings_post.md` |
| API spec | `docs/frontend/api/API_Task084_alert_settings_patch.md` |
| API spec | `docs/frontend/api/API_Task085_alert_settings_delete.md` |
| Envelope chuẩn | `docs/frontend/api/API_RESPONSE_ENVELOPE.md` |
| UC / DB spec | `docs/frontend/UC/Database_Specification.md` §10 (AlertSettings) |
...
- `docs/frontend/api/API_Task082_alert_settings_get_list.md`
- `docs/frontend/api/API_Task083_alert_settings_post.md`
- `docs/frontend/api/API_Task084_alert_settings_patch.md`
- `docs/frontend/api/API_Task085_alert_settings_delete.md`
- `docs/frontend/api/API_RESPONSE_ENVELOPE.md`
- `docs/frontend/UC/Database_Specification.md` §10
...
> Tất cả response JSON (khi có body) bám `docs/frontend/api/API_RESPONSE_ENVELOPE.md`.
