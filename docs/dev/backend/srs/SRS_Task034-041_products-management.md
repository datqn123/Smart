...
> **File (Spring / `smart-erp`):** `docs/backend/srs/SRS_Task034-041_products-management.md`  
...
> **CR Task034 — thứ tự danh sách:** Mặc định / không truyền `sort` → **`id:asc`** (`products.id` tăng dần). Whitelist thêm `id:desc`. Với sort theo cột khác → **tie-break** `p.id ASC` (phân trang ổn định). **GAP:** [`API_Task034_products_get_list.md`](../../../docs/frontend/api/API_Task034_products_get_list.md) cần cùng mặc định + whitelist khi đồng bộ doc.  
...
| :--- | :--- |
| API Task034 | [`../../../docs/frontend/api/API_Task034_products_get_list.md`](../../../docs/frontend/api/API_Task034_products_get_list.md) |
| API Task035 | [`../../../docs/frontend/api/API_Task035_products_post.md`](../../../docs/frontend/api/API_Task035_products_post.md) |
| API Task036 | [`../../../docs/frontend/api/API_Task036_products_get_by_id.md`](../../../docs/frontend/api/API_Task036_products_get_by_id.md) |
| API Task037 | [`../../../docs/frontend/api/API_Task037_products_patch.md`](../../../docs/frontend/api/API_Task037_products_patch.md) |
| API Task038 | [`../../../docs/frontend/api/API_Task038_products_delete.md`](../../../docs/frontend/api/API_Task038_products_delete.md) |
| API Task039 | [`../../../docs/frontend/api/API_Task039_products_post_image.md`](../../../docs/frontend/api/API_Task039_products_post_image.md) |
| API Task041 | [`../../../docs/frontend/api/API_Task041_products_bulk_delete.md`](../../../docs/frontend/api/API_Task041_products_bulk_delete.md) |
| Task040 | **Không có** file `API_Task040_*.md` trong repo — không nằm trong SRS này. |
| Khung API | [`../../../docs/frontend/api/API_PROJECT_DESIGN.md`](../../../docs/frontend/api/API_PROJECT_DESIGN.md) §4.9 |
| Envelope lỗi | [`../../../docs/frontend/api/API_RESPONSE_ENVELOPE.md`](../../../docs/frontend/api/API_RESPONSE_ENVELOPE.md) (tham chiếu) |
| UC / DB tham chiếu | [`../../../docs/frontend/UC/Database_Specification.md`](../../../docs/frontend/UC/Database_Specification.md) §7+ (đối chiếu Flyway; không phát minh tên bảng ngoài migration) |
...
| UI index | [`../../../docs/frontend/mini-erp/features/FEATURES_UI_INDEX.md`](../../../docs/frontend/mini-erp/features/FEATURES_UI_INDEX.md) |
...
**Ví dụ response 200 (rút gọn):** tham [`API_Task034_products_get_list.md`](../../../docs/frontend/api/API_Task034_products_get_list.md) §6.
...
- Bổ sung/điều chỉnh mẫu tại `docs/frontend/api/samples/Task035/`, `Task037/` nếu có.  
...
| **Doc API** | `docs/frontend/api/API_Task035_products_post.md` §6b |
...
| 4 | **`API_BRIDGE`** — **bắt buộc** (REST `mini-erp` — `WORKFLOW_RULE` §0.3): **sau** merge BE | `Mode=verify` tối thiểu; dùng **`Mode=fix-doc`** khi cần cập nhật file `API_*.md` + **`docs/frontend/api/samples/**`** (mock lại dữ liệu mẫu) theo mục 2–3, 5–7 file bridge |
...
Context SRS: @docs/backend/srs/SRS_Task034-041_products-management.md mục §14 (multipart, upload song song).

Đọc theo thứ tự: @frontend/AGENTS/docs/FE_API_CONNECTION_GUIDE.md
→ @docs/frontend/api/API_Task035_products_post.md (bổ sung mục multipart, ví dụ đủ)
→ tạo/cập nhật mẫu tại @docs/frontend/api/samples/Task035/ nếu team dùng
→ @docs/frontend/api/endpoints/Task035.md nếu có
→ đối chiếu @backend/smart-erp/src/main/java (grep Path) — tối thiểu 1 controller/DTO

Output: @docs/frontend/api/bridge/BRIDGE_Task035_products_post.md (bảng mục 5) + mẫu request/response mock đúng thân §14/§8.
```
...
Context SRS: @docs/backend/srs/SRS_Task034-041_products-management.md mục §14.1–14.2 (chỉ ảnh đổi vẫn 200).

Đọc: @frontend/AGENTS/docs/FE_API_CONNECTION_GUIDE.md
→ @docs/frontend/api/API_Task037_products_patch.md
→ @docs/frontend/api/samples/Task037/ (bổ sung mẫu: PATCH chỉ ảnh; mock data minh hoạ)
→ grep Path trong @backend/smart-erp/src/main/java, @frontend/mini-erp/src nếu đã móc

Output: @docs/frontend/api/bridge/BRIDGE_Task037_products_patch.md
```
...
Đọc: @frontend/AGENTS/docs/FE_API_CONNECTION_GUIDE.md
→ @docs/frontend/api/API_Task039_products_post_image.md
→ mẫu tại @docs/frontend/api/samples/Task039/ (nếu có)

Output: @docs/frontend/api/bridge/BRIDGE_Task039_products_post_image.md
```
