...
> **File (Spring / `smart-erp`):** `docs/backend/srs/SRS_Task013_stock-receipts-get-list.md`  
...
| :--- | :--- |
| API spec | [`../../../docs/frontend/api/API_Task013_stock_receipts_get_list.md`](../../../docs/frontend/api/API_Task013_stock_receipts_get_list.md) |
| UC / UI | UC7 — `InboundPage`, `ReceiptTable` (`frontend/mini-erp/src/features/inventory/pages/InboundPage.tsx`) |
| Thiết kế API | [`../../../docs/frontend/api/API_PROJECT_DESIGN.md`](../../../docs/frontend/api/API_PROJECT_DESIGN.md) §4.8 (nếu có) |
| UC / DB (mô tả bổ sung cột) | [`../../../docs/frontend/UC/Database_Specification.md`](../../../docs/frontend/UC/Database_Specification.md) §17–§18 |
...
Theo [`API_Task013_stock_receipts_get_list.md`](../../../docs/frontend/api/API_Task013_stock_receipts_get_list.md) §7 (nguyên văn cấu trúc `data`).
...
- `success`, `error`, `message`, `details`, `data` — khớp [`API_RESPONSE_ENVELOPE.md`](../../../docs/frontend/api/API_RESPONSE_ENVELOPE.md).
