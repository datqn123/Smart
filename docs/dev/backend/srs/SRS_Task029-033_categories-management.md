...
> **File (Spring / `smart-erp`):** `docs/backend/srs/SRS_Task029-033_categories-management.md`  
...
| :--- | :--- |
| API Task029 | [`../../../docs/frontend/api/API_Task029_categories_get_list.md`](../../../docs/frontend/api/API_Task029_categories_get_list.md) |
| API Task030 | [`../../../docs/frontend/api/API_Task030_categories_post.md`](../../../docs/frontend/api/API_Task030_categories_post.md) |
| API Task031 | [`../../../docs/frontend/api/API_Task031_categories_get_by_id.md`](../../../docs/frontend/api/API_Task031_categories_get_by_id.md) |
| API Task032 | [`../../../docs/frontend/api/API_Task032_categories_patch.md`](../../../docs/frontend/api/API_Task032_categories_patch.md) |
| API Task033 | [`../../../docs/frontend/api/API_Task033_categories_delete.md`](../../../docs/frontend/api/API_Task033_categories_delete.md) |
| Khung API design | [`../../../docs/frontend/api/API_PROJECT_DESIGN.md`](../../../docs/frontend/api/API_PROJECT_DESIGN.md) §4.9 |
| UC / DB tham chiếu | [`../../../docs/frontend/UC/Database_Specification.md`](../../../docs/frontend/UC/Database_Specification.md) §2 `Categories` (đối chiếu Flyway) |
...
JWT bắt buộc; **401** khi không xác thực — theo [`API_RESPONSE_ENVELOPE.md`](../../../docs/frontend/api/API_RESPONSE_ENVELOPE.md).
...
> Envelope: `success`, `data`, `message`, `error`, `details` — [`API_RESPONSE_ENVELOPE.md`](../../../docs/frontend/api/API_RESPONSE_ENVELOPE.md).
...
| [`API_Task033_categories_delete.md`](../../../docs/frontend/api/API_Task033_categories_delete.md) — đã cập nhật 26/04/2026 | Khớp SRS/BE (soft-delete, Owner-only) | Gate **Doc Sync:** rà `API_PROJECT_DESIGN` §4.9 nếu còn drift ngắn |
