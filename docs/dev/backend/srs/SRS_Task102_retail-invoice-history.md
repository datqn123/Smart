...
> **File (Spring / `smart-erp`):** `docs/backend/srs/SRS_Task102_retail-invoice-history.md`  
> **Người soạn:** Agent BA  
> **Ngày:** 02/05/2026  
> **Trạng thái:** `Approved`  
...
| API list | [`../../../docs/frontend/api/API_Task102_sales_orders_retail_history_get_list.md`](../../../docs/frontend/api/API_Task102_sales_orders_retail_history_get_list.md) |
| API chi tiết (tái sử dụng) | [`../../../docs/frontend/api/API_Task055_sales_orders_get_by_id.md`](../../../docs/frontend/api/API_Task055_sales_orders_get_by_id.md) — `GET /api/v1/sales-orders/{id}` |
| Checkout POS (nguồn tạo đơn) | [`../../../docs/frontend/api/API_Task060_sales_orders_retail_checkout.md`](../../../docs/frontend/api/API_Task060_sales_orders_retail_checkout.md) |
...
| UC / DB spec | [`../../../docs/frontend/UC/Database_Specification.md`](../../../docs/frontend/UC/Database_Specification.md) — §19 `SalesOrders`, §20 `OrderDetails` |
...
- **`GET /api/v1/sales-orders/{id}`** — tham chiếu [`API_Task055_sales_orders_get_by_id.md`](../../../docs/frontend/api/API_Task055_sales_orders_get_by_id.md).
...
- Bám [`API_RESPONSE_ENVELOPE.md`](../../../docs/frontend/api/API_RESPONSE_ENVELOPE.md) §2 (thành công) và §3 (lỗi).
...
| :--- | :--- | :--- |
| **GAP-1** | File API Task102 | **Đã tạo:** [`API_Task102_sales_orders_retail_history_get_list.md`](../../../docs/frontend/api/API_Task102_sales_orders_retail_history_get_list.md); đã đăng ký `API_PROJECT_DESIGN.md` §4.10 + catalog. |
...
| **Giả định** | Múi giờ cắt `dateFrom`/`dateTo` | Dev chốt và ghi vào [`API_Task102_sales_orders_retail_history_get_list.md`](../../../docs/frontend/api/API_Task102_sales_orders_retail_history_get_list.md) **§5.1**. |
