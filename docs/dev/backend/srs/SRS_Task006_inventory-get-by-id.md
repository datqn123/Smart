...
> **File:** `docs/backend/srs/SRS_Task006_inventory-get-by-id.md`  
...
| :--- | :--- |
| API spec | [`../../../docs/frontend/api/API_Task006_inventory_get_by_id.md`](../../../docs/frontend/api/API_Task006_inventory_get_by_id.md) |
| Thiết kế API catalog | [`../../../docs/frontend/api/API_PROJECT_DESIGN.md`](../../../docs/frontend/api/API_PROJECT_DESIGN.md) §4.7 |
| UC / DB | [`../../../docs/frontend/UC/Database_Specification.md`](../../../docs/frontend/UC/Database_Specification.md) §16 `Inventory`, §5 `WarehouseLocations`, §7 `Products`, §8 `ProductUnits`, §9 `ProductPriceHistory` |
...
| Liên quan | Task005 list — [`../../../docs/frontend/api/API_Task005_inventory_get_list.md`](../../../docs/frontend/api/API_Task005_inventory_get_list.md); Task007 PATCH — [`../../../docs/frontend/api/API_Task007_inventory_patch.md`](../../../docs/frontend/api/API_Task007_inventory_patch.md) |
...
- `docs/frontend/api/API_Task006_inventory_get_by_id.md`, `API_PROJECT_DESIGN.md` §4.7.
- `docs/frontend/UC/Database_Specification.md` các mục Inventory / Products / WarehouseLocations / ProductUnits / ProductPriceHistory.
- `docs/backend/srs/SRS_Task005_inventory-get-list.md` (đồng bộ read-model).
...
Khớp [`API_Task006_inventory_get_by_id.md`](../../../docs/frontend/api/API_Task006_inventory_get_by_id.md) §6–§8; mọi lệch sau này → cập nhật API hoặc ghi GAP §12.
