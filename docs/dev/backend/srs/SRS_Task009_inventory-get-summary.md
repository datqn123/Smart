...
> **File (Spring / `smart-erp`):** `docs/backend/srs/SRS_Task009_inventory-get-summary.md`  
...
| :--- | :--- |
| API spec | [`../../../docs/frontend/api/API_Task009_inventory_get_summary.md`](../../../docs/frontend/api/API_Task009_inventory_get_summary.md) |
| KPI đồng nghĩa | [`../../../docs/frontend/api/API_Task005_inventory_get_list.md`](../../../docs/frontend/api/API_Task005_inventory_get_list.md) — `data.summary` (cùng bốn chỉ số, cùng công thức) |
| SRS list (Task005) | [`SRS_Task005_inventory-get-list.md`](SRS_Task005_inventory-get-list.md) — mục 6 (BR), mục 9 (SQL aggregate) |
| UC / DB | [`../../../docs/frontend/UC/Database_Specification.md`](../../../docs/frontend/UC/Database_Specification.md) — tồn kho UC6 (tham chiếu chữ) |
...
- Khớp [`API_RESPONSE_ENVELOPE.md`](../../../docs/frontend/api/API_RESPONSE_ENVELOPE.md) dự án; mã lỗi string theo convention hiện có (`BAD_REQUEST`, …).
