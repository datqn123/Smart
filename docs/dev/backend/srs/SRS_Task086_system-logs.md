...
> **File (Spring / `smart-erp`):** `docs/backend/srs/SRS_Task086_system-logs.md`  
...
- **Nguồn chân lý:** [`SRS_PRD_system-audit-unified-admin-view.md`](SRS_PRD_system-audit-unified-admin-view.md) (**Approved** 02/05/2026); Flyway **`V43__prd_system_logs_view_admin_only.sql`**; BE `SystemLogsService.requireCanView`; API [`API_Task086`](../../../docs/frontend/api/API_Task086_system_logs_get_list.md) §2.
...
| API spec              | `docs/frontend/api/API_Task086_system_logs_get_list.md` · `docs/frontend/api/API_Task087_system_logs_delete.md` · `docs/frontend/api/API_Task088_system_logs_bulk_delete.md`                                   |
...
- `docs/frontend/api/API_Task086_system_logs_get_list.md`
- `docs/frontend/api/API_Task087_system_logs_delete.md`
- `docs/frontend/api/API_Task088_system_logs_bulk_delete.md`
...
- `docs/frontend/mini-erp/features/FEATURES_UI_INDEX.md` (route `/settings/system-logs`)
...
> Envelope bám `docs/frontend/api/API_RESPONSE_ENVELOPE.md` (success/data/message; lỗi có `error` + `details` khi cần).
