...
> **File (Spring / `smart-erp`):** `docs/backend/srs/SRS_Task064-068_cash-transactions-api.md`  
...
| :--- | :--- |
| API Task064 | [`../../../docs/frontend/api/API_Task064_cash_transactions_get_list.md`](../../../docs/frontend/api/API_Task064_cash_transactions_get_list.md) |
| API Task065 | [`../../../docs/frontend/api/API_Task065_cash_transactions_post.md`](../../../docs/frontend/api/API_Task065_cash_transactions_post.md) |
| API Task066 | [`../../../docs/frontend/api/API_Task066_cash_transactions_get_by_id.md`](../../../docs/frontend/api/API_Task066_cash_transactions_get_by_id.md) |
| API Task067 | [`../../../docs/frontend/api/API_Task067_cash_transactions_patch.md`](../../../docs/frontend/api/API_Task067_cash_transactions_patch.md) |
| API Task068 | [`../../../docs/frontend/api/API_Task068_cash_transactions_delete.md`](../../../docs/frontend/api/API_Task068_cash_transactions_delete.md) |
| Khung API | [`../../../docs/frontend/api/API_PROJECT_DESIGN.md`](../../../docs/frontend/api/API_PROJECT_DESIGN.md) §4.14 |
| Envelope | [`../../../docs/frontend/api/API_RESPONSE_ENVELOPE.md`](../../../docs/frontend/api/API_RESPONSE_ENVELOPE.md) |
| UC / DB (mô tả nghiệp vụ) | [`../../../docs/frontend/UC/Database_Specification.md`](../../../docs/frontend/UC/Database_Specification.md) §12.1 |
...
| UI index | [`../../../docs/frontend/mini-erp/features/FEATURES_UI_INDEX.md`](../../../docs/frontend/mini-erp/features/FEATURES_UI_INDEX.md) — `cashflow/` |
...
| API & UC đã đồng bộ OQ-1–5 | — | Xem `docs/frontend/api/API_Task064`–`068`, `Database_Specification` §12.1 |
