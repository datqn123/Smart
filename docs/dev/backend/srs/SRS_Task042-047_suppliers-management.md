...
> **File (Spring / `smart-erp`):** `docs/backend/srs/SRS_Task042-047_suppliers-management.md`  
...
| :--- | :--- |
| API Task042 | [`../../../docs/frontend/api/API_Task042_suppliers_get_list.md`](../../../docs/frontend/api/API_Task042_suppliers_get_list.md) |
| API Task043 | [`../../../docs/frontend/api/API_Task043_suppliers_post.md`](../../../docs/frontend/api/API_Task043_suppliers_post.md) |
| API Task044 | [`../../../docs/frontend/api/API_Task044_suppliers_get_by_id.md`](../../../docs/frontend/api/API_Task044_suppliers_get_by_id.md) |
| API Task045 | [`../../../docs/frontend/api/API_Task045_suppliers_patch.md`](../../../docs/frontend/api/API_Task045_suppliers_patch.md) |
| API Task046 | [`../../../docs/frontend/api/API_Task046_suppliers_delete.md`](../../../docs/frontend/api/API_Task046_suppliers_delete.md) |
| API Task047 | [`../../../docs/frontend/api/API_Task047_suppliers_bulk_delete.md`](../../../docs/frontend/api/API_Task047_suppliers_bulk_delete.md) |
| Khung API | [`../../../docs/frontend/api/API_PROJECT_DESIGN.md`](../../../docs/frontend/api/API_PROJECT_DESIGN.md) §4.14 (bảng path `/suppliers`) |
| Envelope | [`../../../docs/frontend/api/API_RESPONSE_ENVELOPE.md`](../../../docs/frontend/api/API_RESPONSE_ENVELOPE.md) |
| UC / DB | [`../../../docs/frontend/UC/Database_Specification.md`](../../../docs/frontend/UC/Database_Specification.md) §3 `Suppliers`; **bổ sung thực tế Flyway:** `partnerdebts.supplier_id` **ON DELETE RESTRICT** (§12.2 — không chỉ `StockReceipts`) |
