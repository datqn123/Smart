...
> **File (Spring / `smart-erp`):** `docs/backend/srs/SRS_Task021-028_inventory-audit-sessions.md`  
...
| :--- | :--- |
| API Task021 | [`../../../docs/frontend/api/API_Task021_inventory_audit_sessions_get_list.md`](../../../docs/frontend/api/API_Task021_inventory_audit_sessions_get_list.md) |
| API Task022 | [`../../../docs/frontend/api/API_Task022_inventory_audit_sessions_post.md`](../../../docs/frontend/api/API_Task022_inventory_audit_sessions_post.md) |
| API Task023 | [`../../../docs/frontend/api/API_Task023_inventory_audit_sessions_get_by_id.md`](../../../docs/frontend/api/API_Task023_inventory_audit_sessions_get_by_id.md) |
| API Task024 | [`../../../docs/frontend/api/API_Task024_inventory_audit_sessions_patch.md`](../../../docs/frontend/api/API_Task024_inventory_audit_sessions_patch.md) |
| API Task025 | [`../../../docs/frontend/api/API_Task025_inventory_audit_sessions_patch_lines.md`](../../../docs/frontend/api/API_Task025_inventory_audit_sessions_patch_lines.md) |
| API Task026 | [`../../../docs/frontend/api/API_Task026_inventory_audit_sessions_complete.md`](../../../docs/frontend/api/API_Task026_inventory_audit_sessions_complete.md) |
| API Task027 | [`../../../docs/frontend/api/API_Task027_inventory_audit_sessions_cancel.md`](../../../docs/frontend/api/API_Task027_inventory_audit_sessions_cancel.md) |
| API Task028 | [`../../../docs/frontend/api/API_Task028_inventory_audit_sessions_apply_variance.md`](../../../docs/frontend/api/API_Task028_inventory_audit_sessions_apply_variance.md) |
| API design | [`../../../docs/frontend/api/API_PROJECT_DESIGN.md`](../../../docs/frontend/api/API_PROJECT_DESIGN.md) §4.15 |
| UC / tồn kho | [`../../../docs/frontend/UC/Database_Specification.md`](../../../docs/frontend/UC/Database_Specification.md) §16 `Inventory` |
...
Chi tiết hợp đồng HTTP: `API_Task021`–`028` (và GAP Task029 xóa — §12). **GAP UI:** nếu sau này tách route chi tiết (`/inventory/audit/:id`) chưa có trong [`FEATURES_UI_INDEX.md`](../../../docs/frontend/mini-erp/features/FEATURES_UI_INDEX.md) thì cập nhật index khi Dev chốt navigation.
...
> Chi tiết field-level: **bám nguyên** các mục §5–§6 của từng file `API_Task021` … `API_Task028`. Dưới đây là ví dụ rút gọn + lỗi tiêu biểu; Tester lấy đủ mẫu từ API doc + [`API_RESPONSE_ENVELOPE.md`](../../../docs/frontend/api/API_RESPONSE_ENVELOPE.md).
...
| **029 (GAP)** | **Xóa mềm đợt** (Owner — OQ-9, OQ-16); doc `docs/frontend/api/` | **DELETE** | `/api/v1/inventory/audit-sessions/{id}` |
...
| G10 | Task029 DELETE / Task030 approve | Chưa có `docs/frontend/api/` — path đã chốt OQ-15 (`POST …/approve`). |
