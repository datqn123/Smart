...
> **File (Spring / `smart-erp`):** `docs/backend/srs/SRS_TaskXXX_<slug-kebab>.md`  
...
| :--- | :--- |
| API spec (nếu có) | `docs/frontend/api/API_TaskXXX_*.md` |
| UC / DB spec | `docs/frontend/UC/Database_Specification.md` (mục §…) |
...
> BA tra [`../../../docs/frontend/mini-erp/features/FEATURES_UI_INDEX.md`](../../../docs/frontend/mini-erp/features/FEATURES_UI_INDEX.md) và/hoặc mục UI trong `docs/frontend/api/API_Task*.md`.
...
**Phụ lục UI (nếu task chủ yếu là màn Mini-ERP):** có thể bổ sung mục UI theo [`../../../docs/frontend/srs/SRS_TEMPLATE.md`](../../../docs/frontend/srs/SRS_TEMPLATE.md) — không bắt buộc cho SRS thuần API/backend.
