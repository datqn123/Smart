...
> **File (Spring / `smart-erp`):** `docs/backend/srs/SRS_Task063_finance-ledger-get-list.md`  
...
| :--- | :--- |
| API Task063 | [`../../../docs/frontend/api/API_Task063_finance_ledger_get_list.md`](../../../docs/frontend/api/API_Task063_finance_ledger_get_list.md) — **Approved**, đồng bộ SRS 28/04/2026 |
| Khung API | [`../../../docs/frontend/api/API_PROJECT_DESIGN.md`](../../../docs/frontend/api/API_PROJECT_DESIGN.md) §4.14 (tham chiếu API doc §3) |
| Envelope | [`../../../docs/frontend/api/API_RESPONSE_ENVELOPE.md`](../../../docs/frontend/api/API_RESPONSE_ENVELOPE.md) |
| UC / DB (tham chiếu) | [`../../../docs/frontend/UC/Database_Specification.md`](../../../docs/frontend/UC/Database_Specification.md) §12 `FinanceLedger` |
...
> Nhãn / route theo [`FEATURES_UI_INDEX.md`](../../../docs/frontend/mini-erp/features/FEATURES_UI_INDEX.md) và `API_Task063` §1, §6.
...
- Khớp [`API_RESPONSE_ENVELOPE.md`](../../../docs/frontend/api/API_RESPONSE_ENVELOPE.md).  
