...
> **File:** `docs/backend/srs/SRS_Task078-01_validate-create-user-inputs.md`  
> **Người viết:** Agent BA (Draft)  
> **Ngày:** 24/04/2026  
> **Trạng thái:** Approved

**Traceability:** SRS cha [`SRS_Task078_users-post.md`](./SRS_Task078_users-post.md) · API [`../../../docs/frontend/api/API_Task078_users_post.md`](../../../docs/frontend/api/API_Task078_users_post.md) (mục 3, 6, 7) · Envelope lỗi [`../../../docs/frontend/api/API_RESPONSE_ENVELOPE.md`](../../../docs/frontend/api/API_RESPONSE_ENVELOPE.md) · DTO BE `UserCreateRequest` (`jakarta.validation`)
