...
> **File (Spring / `smart-erp`):** `docs/backend/srs/SRS_Task090_uc9-retail-checkout-stock-deduction.md`  
...
| :--- | :--- |
| API hiện tại (POS checkout) | [`../../../docs/frontend/api/API_Task060_sales_orders_retail_checkout.md`](../../../docs/frontend/api/API_Task060_sales_orders_retail_checkout.md) |
| API POS tìm hàng (tồn hiển thị) | [`../../../docs/frontend/api/API_Task059_pos_products_get_search.md`](../../../docs/frontend/api/API_Task059_pos_products_get_search.md) |
...
| UC / DB spec | [`../../../docs/frontend/UC/Database_Specification.md`](../../../docs/frontend/UC/Database_Specification.md) — kho, đơn, xuất kho |
...
**GAP hợp đồng HTTP:** Chưa có file `docs/frontend/api/API_Task090_*.md` riêng. V1 giữ **cùng path** `POST /api/v1/sales-orders/retail/checkout`, mở rộng logic server; tài liệu đã được đồng bộ vào **`API_Task060`** (trừ tồn theo `StoreProfiles`, 409 thiếu tồn) sau khi SRS này **Approved**.
...
> Tra [`../../../docs/frontend/mini-erp/features/FEATURES_UI_INDEX.md`](../../../docs/frontend/mini-erp/features/FEATURES_UI_INDEX.md).
...
**401 / 403** — giữ mẫu [`API_RESPONSE_ENVELOPE.md`](../../../docs/frontend/api/API_RESPONSE_ENVELOPE.md).
