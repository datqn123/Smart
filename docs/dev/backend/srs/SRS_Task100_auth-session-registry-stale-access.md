...
> **File**: `docs/backend/srs/SRS_Task100_auth-session-registry-stale-access.md`  
> **Loại:** Nghiệp vụ **backend-only** — **không** có file `API_Task100_*` (index **100** theo quy ước task không map endpoint).  
> **Liên quan:** [`SRS_Task001_login-authentication.md`](SRS_Task001_login-authentication.md) (dự kiến cùng thư mục `docs/backend/srs/` khi khởi tạo), [`SRS_Task002_logout.md`](../task002/00-ba/SRS_Task002_logout.md) (`clear` map), [`SRS_Task003_auth_refresh.md`](SRS_Task003_auth_refresh.md).  
...
| Catalog dự án | [`API_PROJECT_DESIGN.md`](../../../docs/frontend/api/API_PROJECT_DESIGN.md) — mục Task100 / SRS |
