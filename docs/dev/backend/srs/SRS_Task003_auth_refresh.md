...
> **File**: `docs/backend/srs/SRS_Task003_auth_refresh.md`  
> **API:** [`../../../docs/frontend/api/API_Task003_auth_refresh.md`](../../../docs/frontend/api/API_Task003_auth_refresh.md)  
...
| 500 | `INTERNAL_SERVER_ERROR` theo [`API_RESPONSE_ENVELOPE.md`](../../../docs/frontend/api/API_RESPONSE_ENVELOPE.md) §3.3 (Doc Sync chỉnh mẫu API nếu còn `INTERNAL_ERROR`) |
...
| Nguồn | Mục đích |
| :--- | :--- |
| [`API_Task003_auth_refresh.md`](../../../docs/frontend/api/API_Task003_auth_refresh.md) | Hợp đồng HTTP |
