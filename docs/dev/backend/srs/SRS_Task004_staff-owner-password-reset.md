...
> **File**: `docs/backend/srs/SRS_Task004_staff-owner-password-reset.md`  
> **Người viết**: Agent BA_SQL (Draft)  
> **Ngày cập nhật**: 24/04/2026  
> **Trạng thái**: Draft

**Traceability:** API [`../../../docs/frontend/api/API_Task004_staff_owner_password_reset.md`](../../../docs/frontend/api/API_Task004_staff_owner_password_reset.md) · UC schema [`../../../docs/frontend/UC/schema.sql`](../../../docs/frontend/UC/schema.sql) (`StaffPasswordResetRequests`, `Users`) · Flyway [`../../smart-erp/src/main/resources/db/migration/V1__baseline_smart_inventory.sql`](../../smart-erp/src/main/resources/db/migration/V1__baseline_smart_inventory.sql)
...
- Envelope lỗi 400/401/403/404/5xx theo [`API_RESPONSE_ENVELOPE.md`](../../../docs/frontend/api/API_RESPONSE_ENVELOPE.md).
...
- **SRS_Task001_login-authentication.md** tại `docs/backend/srs/` — hiện repo tham chiếu nhưng file chưa khởi tạo; cần đồng bộ khi bổ sung.
