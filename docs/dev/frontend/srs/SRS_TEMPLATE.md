...
> **SRS Spring / API (`smart-erp`):** dùng mẫu [`../../../docs/backend/srs/SRS_TEMPLATE.md`](../../../docs/backend/srs/SRS_TEMPLATE.md) (bóc tách nghiệp vụ, OQ PO, JSON HTTP, SQL). File này ưu tiên **UI Mini-ERP** (breakpoint, component, state).
