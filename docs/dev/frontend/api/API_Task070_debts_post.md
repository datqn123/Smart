...
**SRS (BE):** [`../../../docs/backend/srs/SRS_Task069-072_debts-api.md`](../../../docs/backend/srs/SRS_Task069-072_debts-api.md) — **Approved** 30/04/2026; **POST** yêu cầu **`can_view_finance`**; **`created_by = sub`** khi INSERT (cột thêm qua Flyway **V26** — SRS **§4 OQ-2**).
