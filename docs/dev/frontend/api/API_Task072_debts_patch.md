...
**SRS (BE):** [`../../../docs/backend/srs/SRS_Task069-072_debts-api.md`](../../../docs/backend/srs/SRS_Task069-072_debts-api.md) — **Approved** 30/04/2026; **§4** — Cleared + tiền → **409**; `paymentAmount` → **cắt trần**; PATCH chỉ **người tạo** (`created_by`).
