...
> **Trạng thái**: Đồng bộ SRS [`SRS_PRD_customers-admin-soft-delete-single.md`](../../../docs/backend/srs/SRS_PRD_customers-admin-soft-delete-single.md) — **Approved** 02/05/2026; amendment [`SRS_Task048-053_customers-management.md`](../../../docs/backend/srs/SRS_Task048-053_customers-management.md) §0.2  
