...
> **Trạng thái**: Draft *(SRS backend Approved 25/04/2026 — `docs/backend/srs/SRS_Task006_inventory-get-by-id.md`: `relatedLines` chỉ lô **còn hàng** `quantity > 0`; ngoài phạm vi dữ liệu → **404**.)*  
