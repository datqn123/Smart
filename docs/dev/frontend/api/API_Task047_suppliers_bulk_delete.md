...
| **RBAC** | Khuyến nghị **Owner** cho xóa — đồng bộ [`SRS_Task042-047_suppliers-management.md`](../../../docs/backend/srs/SRS_Task042-047_suppliers-management.md) **OQ-1** (Staff chỉ đọc/ghi NCC nếu PO chọn (a)). |
| **Use Case Ref** | UC8 |
