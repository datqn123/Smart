...
| :--- | :--- | :--- | :--- | :---: | :--- |
| Endpoint + method | `docs/frontend/api/API_Task083_alert_settings_post.md` §1 | `backend/smart-erp/src/main/java/com/example/smart_erp/settings/alerts/controller/AlertSettingsController.java` (POST `create`) | `frontend/mini-erp/src/features/settings/api/alertSettingsApi.ts` (`postCreateAlertSetting`) | Y | OK |
