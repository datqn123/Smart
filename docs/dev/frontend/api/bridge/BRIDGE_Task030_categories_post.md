...
**Index UI:** [`docs/frontend/mini-erp/features/FEATURES_UI_INDEX.md`](../../mini-erp/src/features/FEATURES_UI_INDEX.md) — route `/products/categories` → `product-management/pages/CategoriesPage.tsx`; form `CategoryForm.tsx`.
