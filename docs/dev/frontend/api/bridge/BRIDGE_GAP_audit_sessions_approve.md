...
**Nguồn sự thật:** [`docs/backend/srs/SRS_Task021-028_inventory-audit-sessions.md`](../../../../docs/backend/srs/SRS_Task021-028_inventory-audit-sessions.md) §8.1 dòng 292 (Task030 GAP), OQ-15 (`Pending Owner Approval` → `Completed`); BE `AuditSessionsController.approve` → `AuditSessionService.approve`.
