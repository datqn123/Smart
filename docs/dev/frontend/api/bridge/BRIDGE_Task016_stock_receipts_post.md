...
**Ghi chú prompt:** Tài liệu tham chiếu đúng cho Path này là `docs/frontend/api/API_Task016_stock_receipts_patch.md`, không phải `API_Task014_stock_receipts_post.md`.
