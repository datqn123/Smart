...
**Index UI:** [`docs/frontend/mini-erp/features/FEATURES_UI_INDEX.md`](../../mini-erp/src/features/FEATURES_UI_INDEX.md) — `/products/categories` → `CategoriesPage` + `CategoryTable` + `CategoryToolbar` + `CategoryDetailDialog` + `ConfirmDialog`.
