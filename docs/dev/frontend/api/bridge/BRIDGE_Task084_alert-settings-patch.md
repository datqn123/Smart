...
| :--- | :--- | :--- | :--- | :---: | :--- |
| Endpoint + body partial | `docs/frontend/api/API_Task084_alert_settings_patch.md` §1–2 | `backend/smart-erp/src/main/java/com/example/smart_erp/settings/alerts/controller/AlertSettingsController.java` (PATCH `patch`) + `backend/smart-erp/src/main/java/com/example/smart_erp/settings/alerts/service/AlertSettingsService.java` (`PATCH_KEYS`) | `frontend/mini-erp/src/features/settings/api/alertSettingsApi.ts` (`patchAlertSetting`) + `frontend/mini-erp/src/features/settings/pages/AlertSettingsPage.tsx` (Lưu cấu hình → PATCH) | Y | OK |
