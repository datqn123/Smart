...
**Nguồn sự thật:** [`docs/backend/srs/SRS_Task021-028_inventory-audit-sessions.md`](../../../../docs/backend/srs/SRS_Task021-028_inventory-audit-sessions.md) §8.1 dòng 293 (Task031 GAP), OQ-19 (`Pending Owner Approval` → `In Progress`); BE `AuditSessionsController.reject` → `AuditSessionService.reject`.
