...
**Nguồn sự thật:** [`docs/backend/srs/SRS_Task021-028_inventory-audit-sessions.md`](../../../../docs/backend/srs/SRS_Task021-028_inventory-audit-sessions.md) §8.1 (dòng 291–293), §6 BR-12/BR-13, §12 GAP; BE `AuditSessionsController` + `AuditSessionService` + `StockReceiptAccessPolicy.assertOwnerOnly`.
