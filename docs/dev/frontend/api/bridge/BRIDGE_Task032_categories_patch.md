...
**Đã đọc** [`docs/frontend/mini-erp/features/FEATURES_UI_INDEX.md`](../../../mini-erp/src/features/FEATURES_UI_INDEX.md): Y (route `/products/categories` → `CategoriesPage` + `CategoryForm`)
