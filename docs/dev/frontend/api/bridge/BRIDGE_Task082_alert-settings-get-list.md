...
| :--- | :--- | :--- | :--- | :---: | :--- |
| Endpoint + Query | `docs/frontend/api/API_Task082_alert_settings_get_list.md` §1–3 | `backend/smart-erp/src/main/java/com/example/smart_erp/settings/alerts/controller/AlertSettingsController.java` (GET `list`) | `frontend/mini-erp/src/features/settings/api/alertSettingsApi.ts` (`getAlertSettingsList`) | Y | OK |
