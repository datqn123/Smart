...
- Trả **một** NCC đầy đủ cột + **`receiptCount`** + **`lastReceiptAt`** (đã chốt PO — [`SRS_Task042-047_suppliers-management.md`](../../../docs/backend/srs/SRS_Task042-047_suppliers-management.md) **OQ-4(b)**).
