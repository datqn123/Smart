...
**SRS (chân lý triển khai BE):** [`../../../docs/backend/srs/SRS_Task063_finance-ledger-get-list.md`](../../../docs/backend/srs/SRS_Task063_finance-ledger-get-list.md) — **Approved**; cửa sổ ngày mặc định 90 ngày, RBAC `can_view_finance`, `transactionCode` + join `SalesOrders`.
