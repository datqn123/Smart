...
> **Hợp đồng BE (đã Approved):** [`SRS_Task061-062_approvals-pending-and-history.md`](../../../docs/backend/srs/SRS_Task061-062_approvals-pending-and-history.md) — lọc ngày pending theo **`receipt_date`**, trường **`date`** trong item = **`receipt_date`**, thứ tự **`created_at ASC`**, Staff **403**.
