...
| **RBAC** | `can_manage_products` trên controller; **xóa mềm:** chỉ **Owner** (`Jwt` claim `role`, `StockReceiptAccessPolicy.assertOwnerOnly`) — khớp [`SRS_Task029-033_categories-management.md`](../../../../docs/backend/srs/SRS_Task029-033_categories-management.md) §6 |
| **Use Case Ref** | UC8 |
...
Chốt **`200 OK`** + envelope [`API_RESPONSE_ENVELOPE.md`](../../../docs/frontend/api/API_RESPONSE_ENVELOPE.md) (không dùng `204 No Content` để tránh lệch `ApiSuccessResponse`).
