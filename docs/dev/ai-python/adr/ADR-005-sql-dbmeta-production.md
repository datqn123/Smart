...
**SRS_PATH:** `d:\do_an_tot_nghiep\project\docs\ai-python\srs\SRS_AI_Task006_sql-dbmeta-production.md`  
**TASK_FILE:** `d:\do_an_tot_nghiep\project\docs\ai-python\tasks\Task006.md`  
**Date:** 2026-05-11
