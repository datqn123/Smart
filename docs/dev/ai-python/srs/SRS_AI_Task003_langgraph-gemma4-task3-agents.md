...
**Date:** 2026-05-10  
**MCP_PHASE:** 0  
**PRD:** `docs/ai-python/prd/PRD_langgraph-gemma4-task3-agents.md`  
**Task ID:** `Task003`  
...
| **FR-REG-01** | Registry hardening: unknown intent route `general_chat`; thêm `docs/ai-python/intent_registry_howto.md` với checklist thêm intent mới. | PRD `REG-01..03`, D5; registry test + doc exists. |
...
- **Given** repo sau implementation, **When** kiểm tra docs, **Then** tồn tại `docs/ai-python/intent_registry_howto.md` có checklist enum, schema, handler, tests.
