...
**SRS:** `docs/ai-python/srs/SRS_AI_Task001_langgraph-gemma4-task1.md`  
**PRD:** `docs/ai-python/prd/PRD_langgraph-gemma4-task1.md`  
**ADR:** `docs/ai-python/adr/ADR-001-langgraph-gemma4-llm-port.md`  
**Artifact folder:** `docs/ai-python/task001/`
