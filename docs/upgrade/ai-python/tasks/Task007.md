...
**SRS:** `d:\do_an_tot_nghiep\project\docs\ai-python\srs\SRS_AI_Task007_agent-sql-factory-upgrade.md`  
**Artifact folder:** `d:\do_an_tot_nghiep\project\docs\ai-python\task007\`
