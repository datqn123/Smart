...
**Related plans:** Owner plan *Nâng cấp AGENT_SQL* (`nâng_cấp_agent_sql_973e9b61.plan.md`); Spring DDL for table descriptions is **out of scope** here (see [`docs/plans/existing/feature/spring_ai_table_description_registry.plan.md`](../../../../docs/plans/existing/feature/spring_ai_table_description_registry.plan.md)).
