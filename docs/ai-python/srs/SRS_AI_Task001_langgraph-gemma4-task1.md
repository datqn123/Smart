...
9. **FR-09:** Ghi file capability stub `ai_python/docs/task001/01-scope/GATEWAY_CAPABILITY.md` (template bảng: native structured / cần fallback — có thể để trống cho dev điền sau spike).
