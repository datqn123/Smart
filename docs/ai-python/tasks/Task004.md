...
**SRS:** `d:\do_an_tot_nghiep\project\ai_python\docs\srs\SRS_AI_Task004_langgraph-gemma4-task4-spring-fastapi.md`  
**Artifact folder:** `d:\do_an_tot_nghiep\project\ai_python\docs\task004\`
