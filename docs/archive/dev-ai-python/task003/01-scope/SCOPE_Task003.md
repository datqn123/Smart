...
**Tham chiếu:** `docs/ai-python/srs/SRS_AI_Task003_langgraph-gemma4-task3-agents.md` (Approved) · PRD: `docs/ai-python/prd/PRD_langgraph-gemma4-task3-agents.md`
...
| `docs/ai-python/intent_registry_howto.md` | Checklist thêm intent (FR-REG). |
