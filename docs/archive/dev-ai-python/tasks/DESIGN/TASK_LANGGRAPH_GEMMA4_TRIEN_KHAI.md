...
- `docs/plans/existing/feature/ai_chatbot_da_agent_v1.plan.md` — đặc tả graph (state, subgraph `sql_query`, `sql_review`, retry `gen_sql` tối đa 3, registry intent, checkpointer/streaming tuỳ chọn).
