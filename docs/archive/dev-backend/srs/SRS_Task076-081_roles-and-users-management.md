...
> **File (Spring / `smart-erp`)**: `docs/backend/srs/SRS_Task076-081_roles-and-users-management.md`  
> **Người soạn:** Agent BA  
> **Ngày:** 30/04/2026  
> **Trạng thái:** Approved  
...
| :--- | :--- |
| API spec | `docs/frontend/api/API_Task076_roles_get_list.md` · `API_Task077_users_get_list.md` · `API_Task079_users_get_by_id.md` · `API_Task080_users_patch.md` · `API_Task081_users_delete.md` |
| SRS liên quan | `docs/backend/srs/SRS_Task078_users-post.md` (Approved) · `docs/backend/srs/SRS_Task078-02_next-employee-code-suggestion.md` |
| Mini-ERP UI index | `docs/frontend/mini-erp/features/FEATURES_UI_INDEX.md` |
...
| Envelope | `docs/frontend/api/API_RESPONSE_ENVELOPE.md` |
...
- `docs/frontend/api/API_Task076_roles_get_list.md`
- `docs/frontend/api/API_Task077_users_get_list.md`
- `docs/frontend/api/API_Task079_users_get_by_id.md`
- `docs/frontend/api/API_Task080_users_patch.md`
- `docs/frontend/api/API_Task081_users_delete.md`
