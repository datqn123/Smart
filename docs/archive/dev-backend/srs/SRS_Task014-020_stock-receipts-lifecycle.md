...
> **File (Spring / `smart-erp`):** `docs/backend/srs/SRS_Task014-020_stock-receipts-lifecycle.md`  
...
| ---------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| API Task014            | `[../../../docs/frontend/api/API_Task014_stock_receipts_post.md](../../../docs/frontend/api/API_Task014_stock_receipts_post.md)`                                                                                                                                                                      |
| API Task015            | `[../../../docs/frontend/api/API_Task015_stock_receipts_get_by_id.md](../../../docs/frontend/api/API_Task015_stock_receipts_get_by_id.md)`                                                                                                                                                            |
| API Task016            | `[../../../docs/frontend/api/API_Task016_stock_receipts_patch.md](../../../docs/frontend/api/API_Task016_stock_receipts_patch.md)`                                                                                                                                                                    |
| API Task017            | `[../../../docs/frontend/api/API_Task017_stock_receipts_delete.md](../../../docs/frontend/api/API_Task017_stock_receipts_delete.md)`                                                                                                                                                                  |
| API Task018            | `[../../../docs/frontend/api/API_Task018_stock_receipts_submit.md](../../../docs/frontend/api/API_Task018_stock_receipts_submit.md)`                                                                                                                                                                  |
| API Task019            | `[../../../docs/frontend/api/API_Task019_stock_receipts_approve.md](../../../docs/frontend/api/API_Task019_stock_receipts_approve.md)`                                                                                                                                                                |
| API Task020            | `[../../../docs/frontend/api/API_Task020_stock_receipts_reject.md](../../../docs/frontend/api/API_Task020_stock_receipts_reject.md)`                                                                                                                                                                  |
| List (đã có SRS riêng) | `[SRS_Task013_stock-receipts-get-list.md](SRS_Task013_stock-receipts-get-list.md)`, API Task013                                                                                                                                                                                                       |
| UC / DB mô tả          | `[../../../docs/frontend/UC/Database_Specification.md](../../../docs/frontend/UC/Database_Specification.md)` §17–§18                                                                                                                                                                                  |
| Thiết kế API           | `[../../../docs/frontend/api/API_PROJECT_DESIGN.md](../../../docs/frontend/api/API_PROJECT_DESIGN.md)` §4.8, §4.5                                                                                                                                                                                     |
