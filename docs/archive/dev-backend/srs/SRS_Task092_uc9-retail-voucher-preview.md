...
> **File (Spring / `smart-erp`):** `docs/backend/srs/SRS_Task092_uc9-retail-voucher-preview.md`  
...
| API checkout hiện tại | [`../../../docs/frontend/api/API_Task060_sales_orders_retail_checkout.md`](../../../docs/frontend/api/API_Task060_sales_orders_retail_checkout.md) — body `voucherCode`, ghi `salesorders.voucher_id` |
...
| API markdown Task092 | [`../../../docs/frontend/api/API_Task092_vouchers_and_retail_preview.md`](../../../docs/frontend/api/API_Task092_vouchers_and_retail_preview.md) |
| UI index | [`../../../docs/frontend/mini-erp/features/FEATURES_UI_INDEX.md`](../../../docs/frontend/mini-erp/features/FEATURES_UI_INDEX.md) — `/orders/retail`, `POSCartPanel` |
---
