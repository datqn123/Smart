...
> **File (Spring / `smart-erp`):** `docs/backend/srs/SRS_PRD_admin-notifications-entity-dialogs.md`  
...
| UI index — dialog nghiệp vụ | [`../../../docs/frontend/mini-erp/features/FEATURES_UI_INDEX.md`](../../../docs/frontend/mini-erp/features/FEATURES_UI_INDEX.md) — `ReceiptDetailDialog`, `DispatchDetailDialog` |
| UC / DB spec (tham chiếu) | [`../../../docs/frontend/UC/Database_Specification.md`](../../../docs/frontend/UC/Database_Specification.md) — đối chiếu khi SQL Agent bổ sung §10 |
...
- **Tài liệu API:** Tạo `docs/frontend/api/API_PRD_notifications_*.md` (hoặc gán TaskXXX) mô tả đủ §8 — **GAP-API-1**.
...
- **GAP-API-1:** Đã có [`API_PRD_notifications_list_mark_read.md`](../../../docs/frontend/api/API_PRD_notifications_list_mark_read.md) (Draft).
