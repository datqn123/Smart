...
> **File (Spring / `smart-erp`):** `docs/backend/srs/SRS_PRD_cash-transactions-admin-unified-multi-fund.md`  
...
| API hiện hành (cần amend / bổ sung) | `API_Task064` … `API_Task068` trong [`../../../docs/frontend/api/`](../../../docs/frontend/api/); `API_Task063` |
| UC / DB | [`../../../docs/frontend/UC/Database_Specification.md`](../../../docs/frontend/UC/Database_Specification.md) §12, §12.1 — `FinanceLedger.reference_type` / `reference_id` |
...
- **API markdown:** tạo/cập nhật file dưới `docs/frontend/api/` (movements, cash-funds, amend Task064–065).
...
> **Ghi chú:** Đây là **hợp đồng đích** cho các Task API mới / amend — chưa có file `API_Task*` đến khi API Agent sinh spec chi tiết. Shape bám [`API_RESPONSE_ENVELOPE.md`](../../../docs/frontend/api/API_RESPONSE_ENVELOPE.md).
...
- Dùng `success` / `data` / `message` / `error` / `details` như [`API_RESPONSE_ENVELOPE.md`](../../../docs/frontend/api/API_RESPONSE_ENVELOPE.md).  
