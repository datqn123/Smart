...
> **File (Spring / `smart-erp`):** `docs/backend/srs/SRS_PRD_system-audit-unified-admin-view.md`  
...
| UI index | [`../../../docs/frontend/mini-erp/features/FEATURES_UI_INDEX.md`](../../../docs/frontend/mini-erp/features/FEATURES_UI_INDEX.md) — `/settings/system-logs` → `LogsPage` |
