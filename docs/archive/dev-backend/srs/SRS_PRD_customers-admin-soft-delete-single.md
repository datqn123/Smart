...
> **File (Spring / `smart-erp`):** `docs/backend/srs/SRS_PRD_customers-admin-soft-delete-single.md`  
...
| API Task052 (đã đồng bộ bản Draft spec) | [`../../../docs/frontend/api/API_Task052_customers_delete.md`](../../../docs/frontend/api/API_Task052_customers_delete.md) |
| API nhóm KH (list/get/patch — lọc `deleted_at`) | `API_Task048` … `API_Task051` trong [`../../../docs/frontend/api/`](../../../docs/frontend/api/) |
| Envelope | [`../../../docs/frontend/api/API_RESPONSE_ENVELOPE.md`](../../../docs/frontend/api/API_RESPONSE_ENVELOPE.md) |
| UC / DB tham chiếu | [`../../../docs/frontend/UC/Database_Specification.md`](../../../docs/frontend/UC/Database_Specification.md) §4 — **đối chiếu Flyway** |
...
- Bám [`API_RESPONSE_ENVELOPE.md`](../../../docs/frontend/api/API_RESPONSE_ENVELOPE.md); `message` tiếng Việt, không lộ chi tiết kỹ thuật.
