...
> **File**: `docs/backend/srs/SRS_Task101_1_api-permission-per-request.md`  
...
- Envelope lỗi: `ApiErrorCode.FORBIDDEN` — [`ApiErrorCode.java`](../../smart-erp/src/main/java/com/example/smart_erp/common/api/ApiErrorCode.java) / [`API_RESPONSE_ENVELOPE.md`](../../../docs/frontend/api/API_RESPONSE_ENVELOPE.md).
