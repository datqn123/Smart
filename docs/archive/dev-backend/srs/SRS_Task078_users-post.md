...
> **File**: `docs/backend/srs/SRS_Task078_users-post.md`  
> **Người viết**: Agent BA_SQL (Draft)  
> **Ngày cập nhật**: 24/04/2026  
> **Trạng thái**: Approved

**Traceability:** API [`../../../docs/frontend/api/API_Task078_users_post.md`](../../../docs/frontend/api/API_Task078_users_post.md) · Danh sách / read-model [`../../../docs/frontend/api/API_Task077_users_get_list.md`](../../../docs/frontend/api/API_Task077_users_get_list.md) · UC schema [`../../../docs/frontend/UC/schema.sql`](../../../docs/frontend/UC/schema.sql) (`Users`, `Roles`) · Envelope [`../../../docs/frontend/api/API_RESPONSE_ENVELOPE.md`](../../../docs/frontend/api/API_RESPONSE_ENVELOPE.md)
...
- **`staffCode`**: API map `staff_code` — **GAP schema:** bảng `Users` trong `docs/frontend/UC/schema.sql` (đoạn baseline) **chưa** có cột `staff_code`; Task077 DDL gợi ý nằm [`Database_Specification.md`](../../../docs/frontend/UC/Database_Specification.md) §6 — Dev cần Flyway bổ sung trước khi triển khai đủ field; cho đến khi có cột: Open Question hoặc bỏ qua `staffCode` trong INSERT.
