...
**SRS task backend / `smart-erp`** (auth API, persistence, SQL, transaction) — **chỉ** nằm dưới [`docs/backend/`](../../../docs/backend/) (vd. [`docs/backend/srs/README.md`](../../../docs/backend/srs/README.md)). Không tạo SRS auth/Task001–004 tại `docs/frontend/srs/`.
...
- **SRS từ API backend (vd. Task004):** `BA_SQL | Task=Task004 | Mode=draft` → file tại `docs/backend/srs/` — mục 6 [`backend/AGENTS/BA_AGENT_INSTRUCTIONS.md`](../../../backend/AGENTS/BA_AGENT_INSTRUCTIONS.md).
