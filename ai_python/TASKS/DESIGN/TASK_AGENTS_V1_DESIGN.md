...
- `docs/plan/feature/ai_chatbot_da_agent_v1.plan.md` — ánh xạ LangGraph, subgraph SQL (`gen_sql → sql_review → validate_sql → execute_sql → validate_result`), retry sinh SQL tối đa 3, registry intent.
...
| :-- | :-- |
| `docs/plan/feature/ai_chatbot_da_agent_v1.plan.md` | Node graph, state, subgraph, retry §2.1 |
