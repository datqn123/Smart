...
> **File:** `backend/docs/srs/SRS_Task103_ai-table-description-registry.md`  
> **Người soạn:** Agent BA  
> **Ngày:** 11/05/2026  
> **Trạng thái:** Draft  
...
| :--- | :--- |
| Plan tính năng | [`../../../docs/plan/feature/spring_ai_table_description_registry.plan.md`](../../../docs/plan/feature/spring_ai_table_description_registry.plan.md) |
| API spec (`frontend/docs/api`) | **GAP** — chưa có `API_Task103_*.md`; khi triển khai HTTP, Agent API bổ sung và liên kết ngược vào §0. |
...
| OQ-8 | Đường dẫn consumer plan ngoài repo (trong frontmatter plan) — có **mirror** vào `docs/` hoặc `ai_python/docs` không? | Traceability CI | Không |
...
- `docs/plan/feature/spring_ai_table_description_registry.plan.md`
...
- Handoff: cập nhật `docs/plan/feature/…` hoặc `backend/docs/…` theo quy ước team.
...
- Bám [`API_RESPONSE_ENVELOPE.md`](../../../frontend/docs/api/API_RESPONSE_ENVELOPE.md) §2 (thành công) / §3 (lỗi).  
- **GAP:** Chưa có `frontend/docs/api/API_Task103_*.md` — cần bổ sung trước khi coi hợp đồng HTTP là nguồn sự thật cho FE/bridge.
...
| Đường dẫn consumer plan ngoài repo | Traceability | Mirror hoặc link trong `ai_python/docs` / `docs/plan` |
