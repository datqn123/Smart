...
7. Preserve architecture boundaries: Spring enforces auth/RBAC and transactions; Mini-ERP owns UI/cache/messages; LangGraph orchestrates; Harness validates execution; tools stay scoped.
